...
if (isset($_POST['filter'])) {
    $from = $_POST['from'];
    $to = $_POST['to'];
    $sql = "SELECT * FROM surat_masuk INNER JOIN sifat_surat ON surat_masuk.sifat_id = sifat_surat.id_sifat WHERE tanggal_surat BETWEEN '$from' AND '$to'";
    $result = mysqli_query($koneksi, $sql);
} else {
    $sql = "SELECT * FROM surat_masuk INNER JOIN sifat_surat ON surat_masuk.sifat_id = sifat_surat.id_sifat";
    $result = mysqli_query($koneksi, $sql);
}
?>
