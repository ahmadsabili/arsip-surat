...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Masukkan Data Surat Masuk</h4>
                    <form action="controllers/surat-masuk/store.php" class="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-10">
                                <input class="form-control" type="date" id="tanggal_diterima" name="tanggal_diterima" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="float-right mt-2">
                            ...
                            <a href="index.php?page=surat-masuk" class="btn btn-dark">Batal</a>
                        </div>
                    </form>
                </div>
            </div>
